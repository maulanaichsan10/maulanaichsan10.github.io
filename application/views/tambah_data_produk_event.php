          ...
          <div class="col-12">
            <div class="card" style="width: 100%">
              <div class="card-header">
                <h3 class="card-title">Tambah Data Produk Event</h3><br>
              </div>
                 <div class="card-body"> 
                    <form method="POST" action="<?php echo base_url('index.php/Data_p_event/tambahDataAksi')?>">
                      
                      <div class="form-group">
                        <label>Nama Produk Event</label>
                        <input type="text" name="nama_p_event" class="form-control">
                        <?php echo form_error('nama_p_event','<div class="text-small text-danger"></div>')?>
                      </div>
                      <div class="form-group">
                        <label>Deskripsi Produk</label>
                        <input type="text" name="deskripsi_p_event" class="form-control">
                        <?php echo form_error('deskripsi_p_event','<div class="text-small text-danger"></div>')?>
                      </div>
                       <div class="form-group">
                        <label>Harga Produk</label>
                        <input type="number" name="harga_p_event" class="form-control">
                        <?php echo form_error('deskripsi','<div class="text-small text-danger"></div>')?>
                      </div>
                      <div class="form-group">
                        <label>Foto Produk</label>
                        <input type="file" name="foto_p_event" class="form-control">
